...
export default function App() {
  ...
  return <AppLayout page={page} onChange={setPage}>{page === 'chat' ? <ChatPage /> : page === 'knowledge' ? <KnowledgePage /> : page === 'documents' ? <DocumentsPage onUseInChat={() => setPage('chat')} /> : <Placeholder title={labels[page]} />}</AppLayout>
}
