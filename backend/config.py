...
DASHBOARD_DB_PATH = Path(os.getenv("AKZENTA_DASHBOARD_DB", str(PROJECT_PATH / "data" / "dashboard.sqlite3")))
WORKFLOW_DB_PATH = Path(os.getenv("AKZENTA_WORKFLOW_DB", str(PROJECT_PATH / "data" / "workflow_engine.sqlite3")))
CONVERSATION_DB_PATH = Path(os.getenv("AKZENTA_CONVERSATION_DB", str(PROJECT_PATH / "data" / "conversations.sqlite3")))
